function h = plot_matrix(X,t,f,plt,Xerr)
...
if nargin < 5;
   h = imagesc(t,f,X');axis xy; colorbar; title('Spectrogram');
else
   subplot(311); h(1) = imagesc(t,f,squeeze(Xerr(1,:,:))'); axis xy; colorbar; title('Lower confidence');
   subplot(312); h(2) = imagesc(t,f,X'); title('X');axis xy; colorbar;
   subplot(313); h(3) = imagesc(t,f,squeeze(Xerr(2,:,:))'); axis xy; colorbar; title('Upper confidence');
end;
xlabel('t');ylabel('f');
